<script>
    ...
    function createAddress() {
        open(AddressModal, { title: $t(`account.addresses.${type}.label`), type, submit: api.address.create, withoutShadow: true });
    }

    function updateAddress() {
        open(AddressModal, { title: $t(`account.addresses.${type}.label`), information, submit: api.address.update, withoutShadow: true });
    }
    ...
    <div class="py-{information ? 4 : 12} flex flex-col justify-center items-center">
        {#if information}
            ...
            <div class="pt-3 flex flex-col lg:flex-row items-center justify-center">
                <button on:click={updateAddress} class="bg-indigo-200 py-1 px-3 mr-0 lg:mr-6 mb-4 lg:mb-0 rounded">
        ...
        {:else}
            ...
            <button on:click={createAddress} class="bg-gray-200 py-1 px-2 rounded underline mt-2">
