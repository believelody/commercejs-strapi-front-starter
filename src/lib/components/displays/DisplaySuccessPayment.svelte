...
<div>
    <div class="flex flex-col justify-center">
        ...
        <div class="my-2 flex justify-start">
            <section class="text-neutral-dark mr-4">{$t(`checkout.payment.success.${isBillingSameAsShipping ? "shipping-billing" : "shipping"}.title`)} : </section>
        ...
        {#if !isBillingSameAsShipping}
            <div class="mt-2 flex justify-start">
                <section class="text-neutral-dark mr-4">{$t(`checkout.payment.success.billing.title`)} : </section>
                <section class="flex flex-col flex-grow text-md text-neutral-dark">
